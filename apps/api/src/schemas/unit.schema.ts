...
export const unitSchema = z.object({
    ...
    totalTowers: z.number().int().positive('El número de torres debe ser mayor a 0').optional().nullable(),
    totalUnits: z.number().int().positive('El número de unidades debe ser mayor a 0').optional().nullable(),
    defaultPaymentType: z.enum(['INTERNAL', 'EXTERNAL']).default('INTERNAL'),
    consecutiveSeed: z.number().int().min(1, 'El consecutivo debe ser al menos 1').default(1),
    ...
    gmailScanDaysBack: z.number().int().min(1, 'Los días de búsqueda deben ser al menos 1').optional().default(7),
