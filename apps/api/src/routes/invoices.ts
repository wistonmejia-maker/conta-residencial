...
router.put('/:id', async (req, res) => {
    try {
        const {
            providerId, invoiceNumber, invoiceDate, dueDate,
            subtotal, taxIva, retefuenteAmount, reteicaAmount,
            description, pdfUrl, fileUrl, status, isAutogenerated,
            documentType, relatedInvoiceId, adjustmentReason
        } = req.body
        ...
        if (isAutogenerated !== undefined) updateData.isAutogenerated = isAutogenerated
